      ...
      <main className="main-content">
        ...
        {!connected ? (
          <section className="card">
            ...
            >
              {loading ? 'Generating QR...' : qrCode ? 'Waiting for scan...' : 'Connect Wallet'}
            </button>
            ...
            <section className="card">
              ...
              {response?.txHash && (
                <div className="result">
                  ...
                  {response.to && <p><strong>To:</strong> {response.to}</p>}
                  {response.value && <p><strong>Amount:</strong> {response.value}</p>}
                </div>
              )}
            </section>
          </>
