...
export default function Index() {
  ...
  const startScanning = async () => {
    ...
    const phoenixURI = `phoenix://connect?version=1&uuid=a63d7400-28be-410e-b9ec-88164debb3f7&serverUrl=wss%3A%2F%2Fwhales-wallet-replayer-dev.gaimes.dev&publicKey=oGpy%2BDZJE3eUuYwNSDcEqawXg4vdy5QxnvvYYki1WEY%3D`
